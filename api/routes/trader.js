...
router.route("/search").get(TraderController.search);
router.route("/getAllTraders").get(TraderController.getAllTraders);
//route for migration
router.route("/getAllEvery").get(TraderController.getAllEvery);
//route for migration
...
router
  ...
  .put(
    [
      validateParam(schemas.idSchema, "code"),
...
router
  ...
  .get(
    validateParam(schemas.idSchema, "code"),
    TraderController.getTraderGuests
  )
  .post(
    [
      validateParam(schemas.idSchema, "code"),
...
router
  ...
  .get(
    validateParam(schemas.idSchema, "code"),
    TraderController.getTraderComments
  )
