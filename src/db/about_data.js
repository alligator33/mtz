...
const history = [
    {
        title: "Brief History",
        text: `MTZ - Launched in 2016, and since then this has been a life-changing figure for hundreds of thousands of personal Traders, companies & business firms.
                            <br>
                            <br>
                  We are interested in seeing all levels and types of traders grow, with our expertise and premium trading tools, you can achieve your trading goals seamlessly at MTZ.
                        `,
    },
];
...
const profit = [
    ...
    },
    {
        ...
        text: `Overtime as a goal driven team with a solid workforce, we also developed the highly
                            acclaimed MTZ1.0, The most efficient Trading ToolKit according to user conducted surveys &
