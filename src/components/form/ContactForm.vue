      ...
      <div>
        <div class="columns">
          <div class="column is-6">
            <div class="is-size-5" v-if="notification.message !== null">
            ...
            <div
              ...
              class="py-5 rounded-lg px-2 px-sm-5 px-lg-5"
            >
              <h3 class="is-size-4 has-text-left pb-2">Leave a Message</h3>
              ...
              <div>
                  ...
                  <div class="control">
                    <div class="select">
                      <select v-model="form.purpose">
                        ...
                        <option>Request for Trader</option>
                ...
                <div v-if="form.purpose === 'Request for Trader'">
                  <div>
                    <div class="field">
                      <label class="label has-text-left"
                        >Trader Fullname:</label
                      >
                      <div class="control">
                        <input
                          v-model.trim="form.traderName"
                          class="input shortForm"
                          type="text"
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <textarea
                      v-model.trim="$v.form.questions.$model"
                      :class="{
          ...
          <div class="column is-6 ">
            <div class="has-text-left p-10">
              <h3 class="is-size-4 is-size-4-touch">Contact Details</h3>
              <ul class="is-size-4">
                <li v-if="phone.length < 1">
                  <i class="fas fa-phone-alt"></i> Phone Number: <br/> {{ phone }}
                </li>
                <li>
                  <i class="fa-regular fa-envelopes"></i> Email: <br/> {{ emailAddress }}
                </li>
                <li>
                  <i class="pr-2 fa-sharp fa-solid fa-building"></i>Address:  <br/>{{ location }}</li>
              </ul>
            </div>
          </div>
        </div>
