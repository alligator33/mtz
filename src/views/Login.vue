<template>
    <div>
        <div class="container pt-20">
            <h1
                    v-if="notification.error !== null"
                    class="notification is-warning mt-5 mx-5"
            >
                {{ this.notification.error }}
            </h1>
            <h1
                    v-if="notification.success !== null"
                    class="notification is-success mt-5 mx-5"
            >
            ...
            <div class="columns is-mobile">
                <div class="column is-7-desktop is-offset-3-desktop">
                    <div class="mx-5 has-background-white px-3 py-4 my-5">
                        ...
                        <div class="my-5">
                            <button @click="login" class="button is-success mx-3">
                                Login
                            </button>
                            <br/>
            ...
            <div class="">
                <div class="has-background-white"></div>
            </div>
        </div>
    </div>
</template>
