  ...
  <div v-if="loaded">
    <div class="container is-clearfix">
      <div class="section ">
        ...
        <h2
          v-if="message !== null"
          class="container has-background-success my-2 my-4 is-size-3"
        >
          {{ trader.name }} {{ message }}
        </h2>
        ...
        <div class="columns has-background-white px-3  py-3">
              ...
              <div class="field is-horizontal">
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control">
                      <input
                        v-model="trader.completedTrades"
                        class="input shortForm"
                        type="number"
          ...
          <div class="column is-4">
            <div>
              ...
              <button @click="sendFile" class="button is-primary my-5">
                Upload image
              </button>
            </div>
            ...
            <div>
              ...
              <router-link
                ...
                :to="{ name: 'comments', params: { id: trader.code } }"
                ><i class="far fa-comment-dots"></i
                ><span class="px-2">Add Reviews and Comments</span>
              </router-link>

              <router-link
                class="button is-success my-2"
                :to="{ name: 'users', params: { id: trader.code } }"
              >
                <span class=" "
                  ><i class="fas fa-user-plus"></i>Add a New User</span
                >
              </router-link>
            </div>
          </div>
        ...
        <button
          @click="updateTrader(trader.code)"
          class="button  is-large is-full is-primary"
        >
          UPDATE TRADER
        </button>
        ...
        <button class="button has-background-grey is-large mx-5">
          <router-link
            :to="{ name: 'viewTrader', params: { id: trader.code } }"
            class=" has-text-white is-pulled-left"
