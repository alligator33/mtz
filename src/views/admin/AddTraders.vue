<template>
  <div id="newTrader">
    <div class="container">
      <div
        v-if="currentStepNumber === 3 || information === '1'"
        class="mx-5 mt-5"
      >
        <p class="has-background-success mx-5 notify py-3">
          When you click the
          <span class="is-italic">"CREATE NEW TRADER" </span> button, you will
          be directed to "All traders page", <br />
          the First trader <strong>{{ form.name }}</strong> is the most recent
          trader you just created. <br />
          click Edit on the next page to add an image for
            ...
            <div class="px-5 rounded-lg rounded-lg">
              <div class="pb-3 is-clearfix">
                ...
                <template v-if="currentStepNumber === 1">
                  <div>
                    <h1
                      class="has-text-centered mx-3 is-size-4 is-size-7-mobile mb-5"
                    >
                      Step 1 - Personal Info
                    </h1>
                ...
                <template v-if="currentStepNumber === 2">
                  <div>
                    <div class="py-5">
                      <h1 class="text-left mx-3 is-size-4 mb-5">
                        Step 2 - Statistcis
                      </h1>
                    ...
                    <div>
                      <h1 class="is-size-5 has-text-left">
                        Step 4 - Select Trader Assets
                      </h1>
                ...
                <div class="pl-5 py-5">
                  ...
                  >
                    ...
                    ><span class="mx-3"> Create New Trader</span>
                  </button>
                </div>
              </div>
            </div>
    ...
    async newTrader() {
      ...
      try {
        ...
        return this.$router.push({
          name: "editTrader",
          params: { id: this.traderCode.data.createdTraders.code },
        });
      } catch (err) {
        this.message = err;
      }
