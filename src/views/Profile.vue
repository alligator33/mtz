            ...
            <div class="columns is-8">
                ...
                <div class="column is-4 mt-3 mx-3 ">
                    ...
                    <div class="has-background-white my-3 py-3 rounded-lg px-3">
                        ...
                        <div class="button">
                            <router-link class="has-text-black" :to="{name:'contact'}">Contact Trader <i
                                    ...
                                    <div class="media-content">
                                        <div class="content">
                                            ...
                                            <span><i class="far fa-clock"></i><span
                                                ...
                                                guestComment.createdAt | timeAgo
                                                }}</span></span>
                                            <br>
                                            ...
                                            <div>
                                                <div v-for="traderComment in guestComment.replys"
                                                     :key="traderComment.id">
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <p class="image ">
                                                        ...
                                                        <div class="media-content">
                                                            <div class="content">
                                                                <p>
                                                                    ...
                                                                    <span><i class="far fa-clock"></i><span
                                                                            class="mx-2 is-capitalized">{{
                                                                        traderComment.createdAt | timeAgo
                                                                        }}</span></span>
                                                                    <br>
